...
|---|---|---|---|
| 사용자 Who |  | 한양대학교 ERICA 재학생 |  |
| 상황 When/Where |  | 공부할 장소가 필요하거나 강의실 대여가 필요할 경우 / 융합교육관 |  |
| 페인포인트 What — 무엇이 **얼마나** |  | 사용 대상이 아닌 학우가 이용중일 때의 장소 마련 및 사용가능한 장소 파악 |  |
| 성공 기준 Done |  | 원활한 이용 및 혼잡도 개선 시 |  |
...
| 질문 | 후보 A | 후보 B | 후보 C |
|---|---|---|---|
| 이 안에 **누구의 정보**가 들어가는가<br>그 사람이 우리 사용자와 같은 사람인가 |  | ERICA 재학중인 인원들의 정보 우리 사용자와 일치함 |  |
| 쓰고 싶어도 **못 쓰는 사람**은 누구인가 |  | ERICA 재학생이 아닌 사람, 교내 행정을 담당하지 않는 사람 청소부 아주머니 등등 |  |
